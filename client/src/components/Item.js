...
const { RiHeartFill, RiHeartLine, GrStar, BsBookmarkStarFill } = icons;
        ...
        <div className="w-full flex border-t border-orange-600 py-4 ">
            <div className="w-2/5 flex flex-wrap gap-[2px] items-center relative cursor-pointer ">
                ...
                <span
                    ...
                    className="text-white rounded-md absolute right-5 bottom-1"
                >
                    {!isHoverHeart ? <RiHeartLine size={24} /> : <RiHeartFill size={24} color="red" />}
                </span>
            </div>
            <div className="w-3/5">
                ...
                <div className="flex items-center my-5 justify-between">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button type="button" className="bg-white text-blue-700 p-1 rounded-md border border-blue-700">
                            Nhắn zalo
                        </button>
                    </div>
                </div>
